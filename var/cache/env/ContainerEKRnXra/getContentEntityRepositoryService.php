 ...
 */
class getContentEntityRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContentEntityRepository' shared autowired service.
     *
     * @return \App\Repository\ContentEntityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContentEntityRepository.php';

        return $container->privates['App\\Repository\\ContentEntityRepository'] = new \App\Repository\ContentEntityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
